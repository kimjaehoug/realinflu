...
export const getSeasonFromWeek = (week, year) => {
  try {
    ...
    // 예: 25/26절기 = 2024년 36주 ~ 2025년 35주
    // 절기 계산 규칙:
    // - 36주차 이상: 현재 연도/다음 연도 절기 (예: 2024년 36주 -> 24/25절기)
    // - 35주차 이하: 이전 연도/현재 연도 절기 (예: 2025년 35주 -> 24/25절기)
    // - 2025년 36주는 26/27절기가 아니라 25/26절기의 연장으로 처리 (실제 데이터 기준)
    if (weekNum >= 36) {
